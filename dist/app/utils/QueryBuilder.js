...
class QueryBuilder {
    ...
    //* Filter method
    filter() {
        const filter = Object.assign({}, this.query); // make a copy
    ...
    fields() {
        var _a, _b;
        const fields = ((_b = (_a = this.query) === null || _a === void 0 ? void 0 : _a.fields) === null || _b === void 0 ? void 0 : _b.split(',').join(' ')) || ''; // title, location => title location
