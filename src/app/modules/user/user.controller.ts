...
const crateUser = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
...
const getAllUsers = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
  const result = await UserServices.getAllUsersFromDB(req.query as Record<string, string>);
  sendResponse(res, {
    success: true,
    statusCode: httpStatus.CREATED,
