...
const getGuideStats = catchAsync(async (req: Request, res: Response, next: NextFunction) => {
  const decodedToken = req.user as JwtPayload;
  const result = await StatsService.getGuideStatsFromDB(decodedToken.userId);
